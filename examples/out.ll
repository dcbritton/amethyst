...
define dso_local void @bar$int$Matrix(i64 noundef %0, %struct.Matrix* noundef byval(%struct.Matrix) %1) {
  ; Primitive parameter allocations and stores
  %3 = alloca i64
  store i64 %0, i64* %3
  ; End parameter handling
  ...
  %7 = icmp eq i64 %4, %6
  ; End eq expr
  br i1 %7, label %ifbody0, label %exit0
...
body2:
  ...
  ; End eq expr
  br i1 %77, label %ifbody3, label %elsifcond3x0
...
elsifcond3x0:
  ...
  ; End eq expr
  br i1 %82, label %elsifbody3x0, label %elsifcond3x1
...
elsifcond3x1:
  ...
  ; End eq expr
  br i1 %87, label %elsifbody3x1, label %exit3
